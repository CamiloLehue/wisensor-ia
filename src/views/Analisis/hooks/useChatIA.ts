...
export function useChatIA() {
  ...
  const handleAskQuestion = async () => {
    ...
    const loadingMessage: Message = { sender: 'bot', text: "Buscando en WI-DB... Por favor, espera." };
    ...
    try {
      ...
      const errorMessage: Message = {
        sender: 'bot',
        text: `Lo siento, hubo un error al procesar tu pregunta: ${err.message || 'Error desconocido'}.`
      };
